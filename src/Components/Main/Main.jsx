import { code, compass, gallery, light, message, mic, send } from "../../assets/index.js";
    ...
    <div className="flex-1 min-h-lvh pb-[15vh] relative">
      ...
      <div className="max-w-5xl flex flex-col justify-center items-center m-auto">
        <div className="my-12 text-6xl text-[#c4c7c5] font-medium p-5">
          <p>
            <span className="bg-gradient-to-r from-[#4b90ff] to-[#ff5546] bg-clip-text text-transparent">Hello, Aditya.</span>
          </p>
        ...
        <div className="grid gap-4 grid-cols-[repeat(auto-fill,minmax(200px,1fr))] w-full p-5">
          <div className="h-[200px] p-4 bg-[#f0f4f9] rounded-xl relative cursor-pointer hover:bg-[#dfe4ea] duration-200">
            ...
            <img src={compass} alt="" className="w-9 p-1 absolute bg-white rounded-3xl bottom-3 right-3" />
          </div>
          <div className="h-[200px] p-4 bg-[#f0f4f9] rounded-xl relative cursor-pointer hover:bg-[#dfe4ea] duration-200">
            <p className="text-[#585858] text-lg">Briefly summarize this concept: urban planning</p>
            <img src={light} alt="" className="w-9 p-1 absolute bg-white rounded-3xl bottom-3 right-3" />
          </div>
          <div className="h-[200px] p-4 bg-[#f0f4f9] rounded-xl relative cursor-pointer hover:bg-[#dfe4ea] duration-200">
            <p className="text-[#585858] text-lg">Brainstorm team bonding activities for our work retreat</p>
            <img src={message} alt="" className="w-9 p-1 absolute bg-white rounded-3xl bottom-3 right-3" />
          </div>
          <div className="h-[200px] p-4 bg-[#f0f4f9] rounded-xl relative cursor-pointer hover:bg-[#dfe4ea] duration-200">
            <p className="text-[#585858] text-lg">Tell me about React js and React native</p>
            <img src={code} alt="" className="w-9 p-1 absolute bg-white rounded-3xl bottom-3 right-3" />
          </div>
        </div>
        ...
        <div className="main-bottom absolute bottom-0 w-lvh max-w=[900x] p-5 m-auto">
          <div className="flex items-center justify-between gap-5 bg-[#f0f4f9] py-2 px-5 rounded-full">
            <input type="text" placeholder="Enter a prompt here" className="flex-1 bg-transparent outline-none border-none p-2 text-lg" />
            <div className="flex items-center gap-4 justify-center">
              <img src={gallery} alt="" className="w-6 cursor-pointer" />
              <img src={mic} alt="" className="w-6 cursor-pointer" />
              <img src={send} alt="" className="w-6 cursor-pointer" />
            </div>
          </div>
